...
```{r}
save(d_mod_price, file = "df_pricemod.RDATA")
```

```{r}
save(d_mod_pop, file = "d_popmod.RDATA")
```
...
```{r}
save(df_pricemod_no_outliers, file = "dprice_no_outliers.RDATA")
```

```{r}
save(df_popemod_no_outliers, file = "dpop_no_outliers.RDATA")
```
